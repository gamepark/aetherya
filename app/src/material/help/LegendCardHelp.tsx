...
export const LegendCardHelp = (props: MaterialHelpProps) => {
  ...
  if (item.id === undefined) {
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>A human tribe is adjacent to an elf tribe</li>
      </ul>
    </>
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>A human tribe is adjacent to a dwarf tribe</li>
      </ul>
    </>
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>2 goblin tribes are adjacent</li>
      </ul>
    </>
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>2 human tribes are adjacent</li>
      </ul>
    </>
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>2 elf tribes are adjacent</li>
      </ul>
    </>
    ...
    return <>
      ...
      Condition:<br/>
      <ul>
        <li>2 dwarf tribes are adjacent</li>
      </ul>
    </>
